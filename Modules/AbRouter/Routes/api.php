...
Route::middleware(['api', 'auth:api'])->group(function () {
    ...
    Route::get('/v1/related-users', 'RelatedUserController@getAllRelatedUsers');
    Route::get('/v1/all-related-users/{id}', 'RelatedUserController@getRelatedUsers');

    Route::get('/v1/user-tags', 'StatisticsController@showTags');

    Route::get('/v1/display-user-events', 'CustomizationEventController@index');
    Route::post('/v1/display-user-events', 'CustomizationEventController@create');
    Route::patch('/v1/display-user-events/{id}', 'CustomizationEventController@update');
    Route::delete('/v1/display-user-events/{id}', 'CustomizationEventController@delete');
});
