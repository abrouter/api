...
//    }
    ...
    public function showRevenueExperimentStatsForHundredEventsByExperimentIdWhithTwoBranch(ApiTester $I)
    {
        $unsavedEvents = [
        ...
        foreach($response['eventCountersWithDate'] as $branch => $event) {
            $I->seeResponseContainsJson([
                ...
                'percentage' => [
                    $branch => [
                        'first_incremental_events' => '100',
                        'second_incremental_events' => '100'
                    ]
                ],
                'counters' => [
                    $branch => [
                        'first_incremental_events' => '1',
                        'second_incremental_events' => '1'
                    ]
                ]
            ]);
        }
